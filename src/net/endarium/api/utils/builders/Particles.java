...
public enum Particles {
	 ...
	 *
	 * @param property ParticleProperty
	 *
	...
	/**
	 * Represents the particle data for effects like {@link Particles#ITEM_CRACK},
	...
	public static final class ParticlePacket {
		...
		public ParticlePacket(Particles effect, ParticleColor color, boolean longDistance) {
			...
			if (effect == Particles.REDSTONE && color instanceof OrdinaryColor
			...
			try {
				...
				if (version < 8) {
					...
					if (data != null) {
						...
						ReflectionUtils.setValue(packet, true, "k", effect == Particles.ITEM_CRACK ? packetData
